...
\begin{titlepage}
    ...
    {\fontsize{55}{68}\selectfont \textbf{Reporte Sistemas mixtos}}\\[0.5cm]     %Name of the book
    \textcolor{ColorSubtext}{\textsc{\Huge Criptografía y \\[0.4cm] Seguridad}}              %Name of the general theme
...
\section{Sistemas mixtos}
    ...
    \section{Ejemplos de los mismos}
